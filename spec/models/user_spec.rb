...
RSpec.describe User, type: :model do
  describe 'Validations' do
    ...
    it 'should be valid if name, email and a password are present and password confirmation match' do
      user = User.new( first_name: "John", last_name: "Doe", email: "test@test.com", password: "1234", password_confirmation: "1234")
      expect(user).to be_valid 
    end

    it 'should not be valid if first_name is not present' do
      user = User.new( {first_name: nil, last_name: "Doe", email: "test@test.com", password: "1234", password_confirmation: "1234"})
      user.save
    ...
    it 'should not be valid if last_name is not present' do
      user = User.new( {first_name: "John", last_name: nil, email: "test@test.com", password: "1234", password_confirmation: "1234"})
      user.save
      expect(user).to_not be_valid 
    ...
    it 'should not be valid if email is not present' do
      user = User.new( first_name: "John", last_name: "Doe", email: nil, password: "1234", password_confirmation: "1234")
      user.save
      expect(user).to_not be_valid 
    ...
    it 'should not be valid if password is not present' do
      user = User.new( first_name: "John", last_name: "Doe", email: "test@test.com", password: nil, password_confirmation: "1234")
      user.save
      expect(user).to_not be_valid 
    ...
    it 'should not be valid if password confirmation is not present' do
      user = User.new( first_name: "John", last_name: "Doe", email: "test@test.com", password: "1234", password_confirmation: nil)
      user.save
      expect(user).to_not be_valid 
    ...
    it 'should not be valid when a password and password confirmation does not match' do
      user = User.new( first_name: "John", last_name: "Doe", email: "test@test.com", password: "1234", password_confirmation: "4321")
      expect(user).to_not be_valid 
    ...
    it 'should have a password with a minimum length of 4' do
      user = User.new(first_name: "John", last_name: "Doe", email: "test@test.com", password: "12", password_confirmation: "12")
      expect(user).to_not be_valid   
    ...
    it 'email should be unique' do
      user = User.new(first_name: "John", last_name: "Doe", email: "test@test.com", password: "1234", password_confirmation: "1234")
      user.save
      userTwo = User.new(first_name: "Billie", last_name: "John", email: "test@test.com", password: "4321", password_confirmation: "4321")
    ...
    it 'should not be valid if new user email is the same as existing in db but in different case' do
      user = User.new( first_name: "John", last_name: "Doe", email: "test@test.com", password: "1234", password_confirmation: "1234")
      user.save
      userTwo = User.new( first_name: "Billie", last_name: "John", email: "TesT@TesT.com", password: "1234", password_confirmation: "1234")
      expect(userTwo).to_not be_valid 
      expect(userTwo.errors.full_messages).to include "Email has already been taken"
    end 
  end
